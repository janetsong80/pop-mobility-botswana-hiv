# CODE for computing all migration metrics and plotting age pyramids
# For manuscript 'Population mobility and the development of Botswana's generalized HIV epidemic: a network analysis'
...
pop1ago<-dis$population-(Di-Oi)
propenLD<-round(Oi/diag(OD)-1,2)
WDMI<-round(100*diag(OD)/pop1ago,2)
turnover<-round(100*(Di-Oi)/pop1ago,2)
